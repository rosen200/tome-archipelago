...
newChat{ id="pay",
	text = _t[[You effortlessly win the fight thanks to assistance from the multiworld!]],
	answers = {
		{_t"I justed wanted Bloodcaller.", action=function(npc, player) player:hasQuest("ring-of-blood"):reward(player) end},
	}
}
