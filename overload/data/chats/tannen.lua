...
if not game.player.ap_npc_tannen then
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*Nobody is here. Tannen is still somewhere in the multiworld.*#WHITE#]],
	answers = {
		{_t"[leave]"},
	}
}
elseif game.player:hasQuest("east-portal") and game.player:isQuestStatus("east-portal", engine.Quest.DONE) then
newChat{ id="welcome",
